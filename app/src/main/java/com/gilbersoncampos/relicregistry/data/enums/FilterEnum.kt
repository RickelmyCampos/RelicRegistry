...
enum class GeneralBodyShape {
     NATURALISTIC, STYLIZED, CYLINDRICAL, GLOBULAR, TRAPEZOIDAL, PHALLIC;//SOLID, HOLLOW,
}
...
enum class Uses {
    RATTLE, AMULET, CONTAINER, PIPE, MUSICAL_INSTRUMENT, WEAPON, TOYS, OTHER, NOT_IDENTIFIED;
